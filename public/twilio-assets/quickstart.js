...
// console.log(hostname+"/live-stream-token");
...
$.getJSON("http://127.0.0.1:8000/live-stream-token", function(data) {
  ...
  window.addEventListener("load",function(){
    let modal = document.getElementById("roomNameModal");
    let cls = document.querySelector(".close")
    let mdl = this.document.querySelector(".modal")
  ...
  cls.addEventListener("click" , function(){
    cls.parentNode.parentNode.parentNode.remove()
