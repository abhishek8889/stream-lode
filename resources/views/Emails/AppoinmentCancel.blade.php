                                        ...
                                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            ...
                                            @if($mailData['mailto'])
                                                @if($mailData['mailto'] == 'HOST')
                                                    Your appointment with {{ $mailData['guestname'] ?? '' }} is canceled by {{ $mailData['guestname'] ?? '' }}.
                                                @else
                                                    You have canceled your appointment with {{ $mailData['hostname'] ?? '' }}.
                                                @endif
                                            @endif
                                            </td>
                                        </tr>
